// =========================================================================
// NETLIFY BUILD SCRIPT: GENERATE ENV.JS DURING DEPLOYMENT
// Reads process.env on Netlify or falls back to vhs-zps configuration.
// =========================================================================
const fs = require('fs');
...
const content = `// Auto-generated by Netlify build-env.js
window.ENV = {
...
console.log('✅ Successfully generated env.js for Netlify production deployment.');
